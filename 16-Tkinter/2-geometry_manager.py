...
## pack
# eklenen her şey bir bir alta doğru eklenir 
# yön belirtilmemiş ise orta olur sürekli
...
## grid manager
# 5X5 lik 25 gride bölüyoruz ve eklemeleri bunu düşünerek yapıyoruz 
#for r in range(5):
#    for c in range(5):
...
# place
# ekranı kordinat sistemi olarak düşünüp sol üst köşeyi(0,0) konumu olarak ele alıyoruz
